#!/usr/bin/env python3
"""
system.py - Comprehensive system validation for CryptoRecorder.
...
Usage:
    python validators/system.py              # Run all validations
    python validators/system.py --quick      # Quick checks only
    python validators/system.py --verbose    # Detailed output
    python validators/system.py --fix        # Auto-create missing dirs
...
class SystemValidator:
    ...
    def validate_directories(self):
        ...
        def check_converter():
            cli = self.project_root / 'convert_day.py'
            if not cli.exists():
                raise ValueError("convert_day.py not found")
            return "convert_day.py present"
    ...
    def validate_converter(self):
        ...
        def check_converter_cli():
            from convert_day import convert_date, main
            return "convert_day.py imports OK"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python system.py              # Full validation
  python system.py --quick      # Quick checks only
  python system.py --verbose    # Detailed output
  python system.py --fix        # Auto-create missing directories
        """
    )
